...
import model
from data_reader import load_data, DataReader,load_data_for_test
...
def generate_nextwords():
    ...
    word_vocab, char_vocab, word_tensors, char_tensors, max_word_length = \
        load_data_for_test(FLAGS.data_dir, FLAGS.max_word_length, eos=FLAGS.EOS)

    
    print('initialized test dataset reader')
    tw_tensors = word_tensors['next_word']
    tc_tensors = char_tensors['next_word']
...
if __name__ == "__main__":
    #l = [1, 9, 2, 4, 7, 6, 3,10,19,11,20] 
    #min_k = get_topk_index(l, 3)
    #for _ in min_k:
    #    print(_)
